...
class MemoryMap:
    ...
    # =============================
    ALIOS_SYS_SIZE = 0 * SIZE_1M
    ALIOS_LOG_SIZE = 0 * SIZE_1K
    SHARE_MEM_SIZE = 0 * SIZE_1K
    SHARE_PARAM_SIZE = 0 * SIZE_1K
    PQBIN_SIZE = 0 * SIZE_1K
    ALIOS_RESV_SIZE = FREERTOS_SIZE - ALIOS_LOG_SIZE - ALIOS_SYS_SIZE - SHARE_MEM_SIZE - (SHARE_PARAM_SIZE * 2) - PQBIN_SIZE

    MIRROR_2ND_PACK_HEAD_SIZE = 0
