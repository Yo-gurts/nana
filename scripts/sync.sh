...
SOURCE_BUILD="$CURRENT_DIR/nana/build/boards/cv180x/cv1801b_y24_spinand"
TARGET_BUILD="$CURRENT_DIR/build/boards/cv180x/cv1801b_y24_spinand"

SOURCE_RAMDISK="$CURRENT_DIR/nana/ramdisk/rootfs/overlay/cv1801b_y24_spinand"
TARGET_RAMDISK="$CURRENT_DIR/ramdisk/rootfs/overlay/cv1801b_y24_spinand"
